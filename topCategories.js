  ...
  function displayTopGenres(songsData) {
    if (songsData) {
      ...
      sortedGenres.forEach(genre => {
        ...
        genreLink.href = '#'; // Add link functionality here
  ...
  function displayTopArtists(songsData) {
    if (songsData) {
      ...
      sortedArtists.forEach(artist => {
        ...
        artistLink.href = '#'; // Add link functionality here
        artistLink.textContent = artist;
        artistLink.addEventListener('click', () => {
          // Implement functionality to display songs for this artist
...
function displayMostPopularSongs(songsData) {
    if (songsData) {
      ...
      sortedSongsByPopularity.forEach(song => {
        ...
        songLink.href = '#'; // Add link functionality here
        songLink.textContent = song.title;
        songLink.addEventListener('click', () => {
          // Implement functionality to display the single song view for this song
